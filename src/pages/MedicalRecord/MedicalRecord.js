...
<div className='doc-table mt-3 table-responsive d-flex flex-column align-items-center'>
   ...
   {filteredEgyId2.length && <input type='search' placeholder='ابحث عن اسم الدواء...' className='search-medicine my-2 ' value={search} onChange={(e) => setsearch(e.target.value) } />} 
