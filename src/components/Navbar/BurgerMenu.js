...
<ul className='burger-navbar-list d-lg-flex   align-items-center justify-content-center d-none'>
<FontAwesomeIcon className='x-icon' style={{cursor:'pointer'}} onClick={() => setshowburgermenu(false)} icon={faXmark}/ >
...
<div onClick={() => setshowburgermenu(false)} className='burger-patiens-guests-menu'>
...
<div onClick={() => setshowburgermenu(false)} className='burger-patiens-guests-menu star'>
